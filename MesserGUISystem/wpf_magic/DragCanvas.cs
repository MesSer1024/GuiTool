...
namespace MesserGUISystem.wpf_magic {
    /// A Canvas which manages dragging of the Visuals it contains.   
    /// </summary> 
    /// <remarks> 
    ...
    { 
        ...
        public static bool GetCanBeDragged(UIElement Visual) 
        { 
            if (Visual == null) 
                return false; 
 
            return (bool)Visual.GetValue(CanBeDraggedProperty); 
        } 
        public static void SetCanBeDragged(UIElement Visual, bool value) 
        {
            if (Visual != null) 
                Visual.SetValue(CanBeDraggedProperty, value); 
        } 
        ...
        { 
            ...
            { 
                ...
                if (elem != null && base.Children.Contains(elem)) 
                    break; 
                if (depObj is UIElement || depObj is Visual3D) 
